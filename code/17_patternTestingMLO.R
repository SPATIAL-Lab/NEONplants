...
plot(mlo.bouts$Overlap.raw, mlo.bouts$lh10)
plot(mlo.bouts$Overlap.postMed, mlo.bouts$lh10)

# Bouts with more diverse water use have lower LH variation ----
plot(mlo.bouts$Overlap.raw, mlo.bouts$lhVar)
plot(mlo.bouts$Overlap.postMed, mlo.bouts$lhVar)
...
text(mlo.bAnom$Precip60, mlo.bAnom$Overlap.postMed, mlo.bAnom$Bout)
...
# Bouts with more diverse water use have higher LH flux ----
plot(mlo.bAnom$Overlap.raw, mlo.bAnom$lh10)
plot(mlo.bAnom$Overlap.postMed, mlo.bAnom$lh10)

# Bouts with more diverse water use have lower LH variation ----
plot(mlo.bAnom$Overlap.raw, mlo.bAnom$lhVar)
plot(mlo.bAnom$Overlap.postMed, mlo.bAnom$lhVar)
